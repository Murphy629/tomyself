...
.page {
  ...
  align-items: center;   /* center heading + wrapper */
  padding: 2rem 1rem;
}
...
.grafana-wrapper {
  ...
  gap: 1.5rem;                    /* spacing between wrapped items */
  
  width: 100%;
  max-width: 1200px;
  min-height: 500px;              /* ensures a tall enough area */
  ...
  overflow: hidden;               /* ensure no scrollbar/overflow */
}
</style>
