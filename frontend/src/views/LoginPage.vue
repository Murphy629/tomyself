      ...
      <section class="visual">
        <div class="illus">
          <svg viewBox="0 0 300 220" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <rect x="0" y="0" width="300" height="220" rx="16" fill="url(#g2)"/>
            <g opacity="0.9">
              <circle cx="80" cy="80" r="36" fill="white"/>
              <circle cx="220" cy="120" r="48" fill="#e7f1ff"/>
              <rect x="60" y="150" width="180" height="28" rx="6" fill="white"/>
            </g>
          </svg>
        </div>
        <div class="copy">
          <h3>Welcome Back</h3>
          <p>Log in to manage your dashboards, explore data, and track your progress with ease.</p>
          <div class="divider">
            <span></span><span></span>
          </div>
        </div>
...
<style scoped>
/* Directly reuse the style of SignupView to ensure consistent style */
:root {
  --blue-50: #f3f8ff;
  --blue-100: #e6f1ff;
  --blue-200: #d2e7ff;
...
.copy { text-align: left; margin-top: 18px; }
.copy h3 { margin: 0 0 8px; font-weight: 700; color: var(--text-900); }
.copy p { color: var(--text-600); line-height: 1.6; }
...
.form h2 { margin: 0 0 18px; font-size: 28px; }
